          ...
          <section className="profileContainer">
            {/* Profile Dashboard Section */}
              ...
              <div className="profileDashBoard">
                <div className="topD">
                  <div className='div'><Link to={"/homePage"}><p><IoMdArrowRoundBack /></p></Link></div><div><h4>Name</h4><p>Post 0</p></div>
                </div>
                <div className="bgPhoto"><img src="" alt="" /></div>
                <div className="userIng"><img src="" alt="" /></div>
              </div>
              <div className="profileDashBoard2">
                <div className="editProfile"><p>Edit Profile</p></div>
